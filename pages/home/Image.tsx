...
const Image = () => {
  return (
    <div className='bg-gray-50 pt-20 pb-32 relative overflow-hidden'>
        <div className='flex overflow-hidden items-end  bg-image-section  bg-[length:80%_1000px] bg-top bg-no-repeat w-[80%] h-[600px] m-auto rounded-t-3xl rounded-bl-3xl'>
